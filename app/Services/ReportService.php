...
class ReportService
{
    ...
    public function handleStockAdjustment( ProductHistory $history )
    {
        if ( in_array( $history->operation_type, [
             ...
             */
            $message = __( 'A stock operation has recently been detected, however '.config('app.name').' was\'nt able to update the report accordingly. This occurs if the daily dashboard reference has\'nt been created.' );
