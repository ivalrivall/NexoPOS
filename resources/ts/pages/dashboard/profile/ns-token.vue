        ...
        <div class="px-2 w-full md:w-1/2">
            <div class="mb-4">
                <ns-notice>
                    ...
                    <template #description>{{ __( `Token are used to provide a secure access to Beanhouseval resources without having to share your personal username and password.
